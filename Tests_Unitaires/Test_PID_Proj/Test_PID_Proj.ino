...
void sendTrame()
{
  String trame = String(temp_SEN)+" "+String(humid_SEN)+" "+String(ppm_Dioxide)+" "+String(ppb_TVOC)+" "+String(states[state_PID])+" "+String(temp_GND)+" "+String(humid_GND);
